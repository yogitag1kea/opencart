...
class ControllerCatalogProduct extends Controller {
	...
	protected function validateForm() {
		if (!$this->seller->hasPermission('modify', 'catalog/product')) {
		...
		foreach ($this->request->post['product_description'] as $language_id => $value) {
			...
			if (mb_substr($value['barcode'], 0, 3,'UTF8')!='890'){
				$this->error['barcode'][$language_id] = $this->language->get('error_barcode');
			}
