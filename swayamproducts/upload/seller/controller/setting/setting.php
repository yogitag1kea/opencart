...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_seller_language'])) {
			$data['config_seller_language'] = $this->request->post['config_seller_language'];
		} else {
			$data['config_seller_language'] = $this->config->get('config_seller_language');
		}
	...
	protected function validate() {
		if (!$this->seller->hasPermission('modify', 'setting/setting')) {
		...
		if (!$this->request->post['config_limit_admin']) {
			$this->error['limit_seller'] = $this->language->get('error_limit');
		}
