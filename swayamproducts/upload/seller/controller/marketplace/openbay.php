...
class ControllerMarketplaceOpenbay extends Controller {
	...
	public function install() {
		...
		if (!$this->seller->hasPermission('modify', 'marketplace/openbay')) {
			...
			$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'access', 'extension/openbay/' . $this->request->get['extension']);
			$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'modify', 'extension/openbay/' . $this->request->get['extension']);
	...
	public function patch() {
		...
		if (!in_array('openbay', $installed_modules)) {
			...
			$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'access', 'marketplace/openbay');
			$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'modify', 'marketplace/openbay');
		}
	...
	public function orderListUpdate() {
		if (!isset($this->request->post['selected']) || empty($this->request->post['selected'])) {
            ...
            if ($api_info && $this->seller->hasPermission('modify', 'sale/order')) {
	...
	public function eventMenu($route, &$data) {
		...
		if ($this->seller->hasPermission('access', 'marketplace/openbay')) {
			$openbay_menu[] = array(
			...
			if ($this->seller->hasPermission('access', 'extension/openbay/ebay') && $this->config->get('ebay_status') == 1) {
				$ebay[] = array(
					'name'     => $this->language->get('text_openbay_dashboard'),
			...
			if ($this->seller->hasPermission('access', 'extension/openbay/amazon') && $this->config->get('openbay_amazon_status') == 1) {
				$amazon_eu[] = array(
					'name'     => $this->language->get('text_openbay_dashboard'),
			...
			if ($this->seller->hasPermission('access', 'extension/openbay/amazonus') && $this->config->get('openbay_amazonus_status') == 1) {
				$amazon_us[] = array(
					'name'     => $this->language->get('text_openbay_dashboard'),
			...
			if ($this->seller->hasPermission('access', 'extension/openbay/etsy') && $this->config->get('etsy_status') == 1) {
				$etsy[] = array(
					'name'     => $this->language->get('text_openbay_dashboard'),
				...
				if ($this->seller->hasPermission('access', 'extension/openbay/etsy_product')) {
					$etsy[] = array(
						'name'	   => $this->language->get('text_openbay_links'),
			...
			if ($this->seller->hasPermission('access', 'extension/openbay/fba') && $this->config->get('openbay_fba_status') == 1) {
				$fba[] = array(
					'name'     => $this->language->get('text_openbay_dashboard'),
