...
class ControllerExtensionOpenbayAmazon extends Controller {
	public function install() {
		...
		$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'access', 'extension/openbay/amazon_listing');
		$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'modify', 'extension/openbay/amazon_listing');
		$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'access', 'extension/openbay/amazon_product');
		$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'modify', 'extension/openbay/amazon_product');
	...
	protected function validate() {
		if (!$this->seller->hasPermission('modify', 'extension/openbay/amazon')) {
