...
class ControllerExtensionOpenbayEtsy extends Controller {
	public function install() {
		...
		$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'access', 'extension/openbay/etsy_product');
		$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'modify', 'extension/openbay/etsy_product');
		$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'access', 'extension/openbay/etsy_shipping');
		$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'modify', 'extension/openbay/etsy_shipping');
		$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'access', 'extension/openbay/etsy_shop');
		$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'modify', 'extension/openbay/etsy_shop');
	...
	protected function validate() {
		if (!$this->seller->hasPermission('modify', 'extension/openbay/etsy')) {
