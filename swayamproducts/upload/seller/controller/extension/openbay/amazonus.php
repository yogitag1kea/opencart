...
class ControllerExtensionOpenbayAmazonus extends Controller {
	public function install() {
		...
		$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'access', 'extension/openbay/amazonus_listing');
		$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'modify', 'extension/openbay/amazonus_listing');
		$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'access', 'extension/openbay/amazonus_product');
		$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'modify', 'extension/openbay/amazonus_product');
	...
	protected function validate() {
		if (!$this->seller->hasPermission('modify', 'extension/openbay/amazonus')) {
