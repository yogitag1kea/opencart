...
class ControllerExtensionOpenbayEbay extends Controller {
	public function install() {
		...
		$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'access', 'extension/openbay/ebay_profile');
		$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'modify', 'extension/openbay/ebay_profile');
		$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'access', 'extension/openbay/ebay_template');
		$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'modify', 'extension/openbay/ebay_template');
	...
	private function validate() {
		if (!$this->seller->hasPermission('modify', 'extension/openbay/ebay')) {
