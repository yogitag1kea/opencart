...
class ControllerExtensionExtensionTotal extends Controller {
	...
	public function install() {
		...
		if ($this->validate()) {
			...
			$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'access', 'extension/total/' . $this->request->get['extension']);
			$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'modify', 'extension/total/' . $this->request->get['extension']);
	...
	protected function validate() {
		if (!$this->seller->hasPermission('modify', 'extension/extension/total')) {
