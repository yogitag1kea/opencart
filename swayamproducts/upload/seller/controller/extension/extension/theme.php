...
class ControllerExtensionExtensionTheme extends Controller {
	...
	public function install() {
		...
		if ($this->validate()) {
			...
			$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'access', 'extension/theme/' . $this->request->get['extension']);
			$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'modify', 'extension/theme/' . $this->request->get['extension']);
	...
	protected function validate() {
		if (!$this->seller->hasPermission('modify', 'extension/extension/theme')) {
