...
class ControllerExtensionExtensionPayment extends Controller {
	...
	public function install() {
		...
		if ($this->validate()) {
			...
			$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'access', 'extension/payment/' . $this->request->get['extension']);
			$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'modify', 'extension/payment/' . $this->request->get['extension']);
	...
	protected function validate() {
		if (!$this->seller->hasPermission('modify', 'extension/extension/payment')) {
