...
class ControllerExtensionPaymentPPExpress extends Controller {
	...
	protected function validate() {
		if (!$this->seller->hasPermission('modify', 'extension/payment/pp_express')) {
	...
	public function connectRedirect() {
		if ($this->seller->hasPermission('modify', 'extension/extension/payment') && $this->seller->hasPermission('modify', 'extension/payment/pp_express')) {
