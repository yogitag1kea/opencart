...
class ControllerExtensionModulePPBraintreeButton extends Controller {
	...
	public function configure() {
		...
		if (!$this->seller->hasPermission('modify', 'extension/extension/module')) {
			...
			$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'access', 'extension/module/pp_braintree_button');
			$this->model_user_user_group->addPermission($this->seller->getGroupId(), 'modify', 'extension/module/pp_braintree_button');
	...
	protected function validate() {
		if (!$this->seller->hasPermission('modify', 'extension/module/pp_braintree_button')) {
