...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->seller->hasPermission('access', 'catalog/category')) {
				$catalog[] = array(
			...
			if ($this->seller->hasPermission('access', 'catalog/recurring')) {
				$catalog[] = array(
			...
			if ($this->seller->hasPermission('access', 'catalog/filter')) {
				$catalog[] = array(
			...
			if ($this->seller->hasPermission('access', 'catalog/attribute')) {
				$attribute[] = array(
			...
			if ($this->seller->hasPermission('access', 'catalog/attribute_group')) {
				$attribute[] = array(
			...
			if ($this->seller->hasPermission('access', 'catalog/option')) {
				$catalog[] = array(
			...
			if ($this->seller->hasPermission('access', 'catalog/manufacturer')) {
				$catalog[] = array(
			...
			if ($this->seller->hasPermission('access', 'catalog/download')) {
				$catalog[] = array(
			...
			if ($this->seller->hasPermission('access', 'catalog/review')) {		
				$catalog[] = array(
			...
			if ($this->seller->hasPermission('access', 'catalog/information')) {		
				$catalog[] = array(
			...
			// if ($this->seller->hasPermission('access', 'marketplace/marketplace')) {		
			// 	$marketplace[] = array(
			...
			// if ($this->seller->hasPermission('access', 'marketplace/installer')) {		
			// 	$marketplace[] = array(
			...
			// if ($this->seller->hasPermission('access', 'marketplace/extension')) {		
			// 	$marketplace[] = array(
			...
			// if ($this->seller->hasPermission('access', 'marketplace/modification')) {
			// 	$marketplace[] = array(
			...
			// if ($this->seller->hasPermission('access', 'marketplace/event')) {
			// 	$marketplace[] = array(
			...
			if ($this->seller->hasPermission('access', 'design/layout')) {
				$design[] = array(
			...
			if ($this->seller->hasPermission('access', 'design/theme')) {	
				$design[] = array(
			...
			if ($this->seller->hasPermission('access', 'design/translation')) {
				$design[] = array(
			...
			if ($this->seller->hasPermission('access', 'design/banner')) {
				$design[] = array(
			...
			if ($this->seller->hasPermission('access', 'design/seo_url')) {
				$design[] = array(
			...
			if ($this->seller->hasPermission('access', 'sale/recurring')) {	
				$sale[] = array(
					'name'	   => $this->language->get('text_recurring'),
			...
			if ($this->seller->hasPermission('access', 'sale/return')) {
				$sale[] = array(
			...
			if ($this->seller->hasPermission('access', 'sale/voucher')) {
				$voucher[] = array(
			...
			if ($this->seller->hasPermission('access', 'sale/voucher_theme')) {
				$voucher[] = array(
			...
			if ($this->seller->hasPermission('access', 'customer/customer')) {
				$customer[] = array(
			...
			if ($this->seller->hasPermission('access', 'customer/customer_group')) {
				$customer[] = array(
			...
			if ($this->seller->hasPermission('access', 'customer/customer_approval')) {
				$customer[] = array(
			...
			if ($this->seller->hasPermission('access', 'customer/custom_field')) {		
				$customer[] = array(
			...
			if ($this->seller->hasPermission('access', 'setting/setting')) {
				$system[] = array(
			...
			if ($this->seller->hasPermission('access', 'user/user')) {
				$user[] = array(
			...
			if ($this->seller->hasPermission('access', 'user/user_permission')) {	
				$user[] = array(
			...
			if ($this->seller->hasPermission('access', 'user/api')) {		
				$user[] = array(
			...
			// if ($this->seller->hasPermission('access', 'seller/user')) {
				$user[] = array(
					'name'	   => $this->language->get('text_sellers'),
					'href'     => $this->url->link('seller/user', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			// }
			...
			if ($this->seller->hasPermission('access', 'localisation/location')) {
				$localisation[] = array(
			...
			if ($this->seller->hasPermission('access', 'localisation/language')) {
				$localisation[] = array(
			...
			if ($this->seller->hasPermission('access', 'localisation/currency')) {
				$localisation[] = array(
			...
			if ($this->seller->hasPermission('access', 'localisation/stock_status')) {
				$localisation[] = array(
			...
			if ($this->seller->hasPermission('access', 'localisation/order_status')) {
				$localisation[] = array(
			...
			if ($this->seller->hasPermission('access', 'localisation/return_status')) {
				$return[] = array(
			...
			if ($this->seller->hasPermission('access', 'localisation/return_action')) {
				$return[] = array(
			...
			if ($this->seller->hasPermission('access', 'localisation/return_reason')) {
				$return[] = array(
			...
			if ($this->seller->hasPermission('access', 'localisation/country')) {
				$localisation[] = array(
			...
			if ($this->seller->hasPermission('access', 'localisation/zone')) {
				$localisation[] = array(
			...
			if ($this->seller->hasPermission('access', 'localisation/geo_zone')) {
				$localisation[] = array(
			...
			if ($this->seller->hasPermission('access', 'localisation/tax_class')) {
				$tax[] = array(
			...
			if ($this->seller->hasPermission('access', 'localisation/tax_rate')) {
				$tax[] = array(
			...
			if ($this->seller->hasPermission('access', 'localisation/length_class')) {
				$localisation[] = array(
			...
			if ($this->seller->hasPermission('access', 'localisation/weight_class')) {
				$localisation[] = array(
			...
			if ($this->seller->hasPermission('access', 'tool/backup')) {
				$maintenance[] = array(
			...
			if ($this->seller->hasPermission('access', 'tool/upload')) {
				$maintenance[] = array(
			...
			if ($this->seller->hasPermission('access', 'tool/log')) {
				$maintenance[] = array(
			...
			if ($this->seller->hasPermission('access', 'report/report')) {
				$report[] = array(
			...
			if ($this->seller->hasPermission('access', 'report/online')) {
				$report[] = array(
			...
			if ($this->seller->hasPermission('access', 'report/statistics')) {
				$report[] = array(
