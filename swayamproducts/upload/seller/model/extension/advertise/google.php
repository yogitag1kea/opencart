...
class ModelExtensionAdvertiseGoogle extends Model {
    private $events = array(
        'seller/view/common/column_left/before' => array(
            'extension/advertise/google/admin_link',
        ),
        'seller/model/catalog/product/addProduct/after' => array(
            'extension/advertise/google/addProduct',
        ),
        'seller/model/catalog/product/copyProduct/after' => array(
            'extension/advertise/google/copyProduct',
        ),
        'seller/model/catalog/product/deleteProduct/after' => array(
