...
$_['entry_seller_language']           = 'Seller Language';
$_['entry_currency']                 = 'Currency';
$_['entry_currency_auto']            = 'Auto Update Currency';
$_['entry_length_class']             = 'Length Class';
$_['entry_weight_class']             = 'Weight Class';
$_['entry_limit_seller']              = 'Default Items Per Page (Seller)';
...
$_['help_limit_admin']               = 'Determines how many seller items are shown per page (orders, customers, etc).';
...
$_['help_login_attempts']            = 'Maximum login attempts allowed before the account is locked for 1 hour. Customer and affliate accounts can be unlocked on the customer or affliate seller pages.';
...
$_['help_api']                       = 'Default API user the seller should use.';
...
$_['help_secure']                    = 'To use SSL check with your host if a SSL certificate is installed and add the SSL URL to the catalog and seller config files.';
...
$_['help_maintenance']               = 'Prevents customers from browsing your store. They will instead see a maintenance message. If logged in as seller, you will see the store as normal.';
$_['help_password']                  = 'Allow forgotten password to be used for the seller. This will be disabled automatically if the system detects a hack attempt.';
